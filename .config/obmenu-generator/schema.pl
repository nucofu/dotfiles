...
our $SCHEMA = [
    ...
    #{item => ['waterfox',		  'Web Browser',  'web-browser']},
    ...
    {beg => ['Advanced Settings', 'applications-engineering']},
      ...
      # Configuration files
      {item => ["$editor ~/.config/conky/default.conkyrc",              'Conky RC',    'text-x-generic']},
      {item => ["$editor ~/.config/dunst/dunstrc", 'Dunst RC', 'text-x-generic']},
    ...
    {beg => ['Exit', 'application-exit']},
      ...
      {item => ["loginctl reboot", 'Reboot', 'system-reboot']},
      {item => ["loginctl poweroff", 'Power Off', 'system-shutdown']},
    {end => undef},
